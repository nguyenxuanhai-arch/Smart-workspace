...
import { Plus, Pencil, Eye, Trash2, Search, ChevronLeft, ChevronRight } from 'lucide-react'
                ...
                <tr key={p.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/60">
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3 text-slate-400">
                      <Link to={`${ADMIN_ROUTES.productForm}?editId=${p.id}`} className="hover:text-brand-teal transition-colors">
                        <Pencil size={16} />
                      </Link>
